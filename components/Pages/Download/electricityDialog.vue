...
export default {
  ...
  methods: {
    ...
    async getPowerRecordExcel(val) {
      ...
      const res = await backendApi.getPowerRecordExcel(data);
      if (res) {
        try {
